...
def process_clip(frame_dir, subscene):
...
if __name__ == "__main__":
    ...
    load_directory = "V:\\Uni4\\SoloProject\\Frames\\4_3_500_5_3_10_C_False\\"
    ...
    for scene in os.listdir(load_directory)[4:]:
        ...
        if True: # lazy indent
            ...
            for subscene in os.listdir(scenes_directory):
                ...
                p1 = multiprocessing.Process(target=process_clip, args=(frame_dir, subscene))
                threads.append(p1)
                p1.start() 
