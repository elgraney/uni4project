...
#   3. Data set creation; pointsflow, relative values, debuggging = false
...
os.system(path)
path = "python directionalFramesEVD.py points True False"
os.system(path)
path = "python estimationDirectional.py points directionalRelPoints"
os.system(path)
path = "python featurePerformanceStats.py directionalRelPoints"
os.system(path)